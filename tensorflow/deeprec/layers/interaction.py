...
from tensorflow.python.ops.init_ops import Zeros, Ones, Constant, TruncatedNormal, glorot_normal_initializer as glorot_normal, glorot_uniform_initializer as glorot_uniform
